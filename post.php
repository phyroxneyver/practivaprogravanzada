...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $carrera = $_POST['carrera']; 
          ...
          if ($pdo) {
            ...
            $successMsg = "<br><br>Datos Añadidos Correctamente<br><br>Datos: <br><br> 
            Nombres: $name <br><br> 
...
<meta charset="UTF-8">
    ...
    <style>
        ...
        .center-content {
            ...
            background-color: #FFF; /* Color de fondo rosado claro */
            box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); /* Sombra suave */
            border-radius: 10px;
        }
        
        h2 {
            color: #000; /* Color morado intenso */
            margin-top: 0;
            padding-top: 10px;
        }
        ...
        .data-table {
            ...
            padding: 20px;
            border: 1px solid #ccc;
            background-color: #FFF; /* Color azul claro */
            border-radius: 10px;
        }
...
<div class="center-content">
    ...
    <div class="data-table">
        ...
        if (!empty($datos)) {
            echo "<h2>Historial de Usuarios</h2>";
            echo "<table>";
            echo "<tr>";
            echo "<th>Nombres</th>";
